...
class TBN(nn.Module):
    ...
    def __init__(self, num_in_layers, num_out_layers, vol_dim=32, num_features=128,tensor_type='torch.FloatTensor', ):
        ...
        self.deconv3d_32_64 = nn.ConvTranspose3d(4,4,(4,4,4),stride = (2,2,2),padding=(1,1,1))
        self.deconv3d_64_128 = nn.ConvTranspose3d(4,4,(4,4,4),stride = (2,2,2),padding=(1,1,1))
    ...
    def encode(self, src_rgb):
        ...
        #---------------------32-64-128-----------------------------------
        #print(x_out.shape)
        x_out = self.deconv3d_32_64(x_out)
        encoded_3d_vol = self.deconv3d_64_128(x_out)
        #print("encoded_3d_vol.shape:", encoded_3d_vol.shape)

        #return x_out

        return encoded_3d_vol
