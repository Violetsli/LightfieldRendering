...
class Dataset(torch.utils.data.Dataset):
    ...
    def get_allcameras(self):
        print("self.allcameras",self.allcameras)
    ...
    def __getitem__(self, idx):
        ...
        if cam is not None:
            ...
            """print("result[fixedcamimage]:",result["fixedcamimage"].shape)
            print("result[validinput]:",result["validinput"].shape)
            print("camrot:",result["camrot"].shape,result["camrot"])
            print("campos:",result["campos"].shape,result["campos"])
            print("result[focal]:",result["focal"].shape,result["focal"])
            print("result[princpt]:",result["princpt"].shape,result["princpt"])
            print("result[camindex]:",result["camindex"])
            print("result[image]:",result["image"].shape)
            print("result[imagevalid]:",result["imagevalid"].shape)
            print("result[pixelcoords]:",result["pixelcoords"].shape)"""
