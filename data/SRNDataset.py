...
class SRNDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        with open(intrin_path, "r") as intrinfile:
            ...
            all_intrinsics[0,0] = focal
            all_intrinsics[1,1] = focal
            all_intrinsics[0,2] = cx
            all_intrinsics[1,2] = cy
            all_intrinsics[2,2] = 1.0
            #print("lines:", lines)
           # all_intrinsics.append(focal)
            #all_intrinsics.append(0.0)
            #all_intrinsics.append(0.0)
        ...
        #print("focal,c:",focal,cx,cy)
        #print(self.z_near, self.z_far)
        result = {
            "path": dir_path,
            #"img_id": index,
            "focal": focal,
